...
public final class ReceiverHelper {
    ...
    private static void parserReceivers(Context context, File apkFile) throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            String archiveSourcePath = context.getFileStreamPath("receiverPlugin-debug.apk").getCanonicalPath();
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            //Build.VERSION.SDK_INT >= 15
            String destCodePath = context.getFileStreamPath("receiverPlugin-debug.apk").getCanonicalPath();
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            ...
            generateReceiverInfo = packageParserClass.getDeclaredMethod("generateActivityInfo",
